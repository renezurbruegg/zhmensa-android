...
public class FavoriteMensa extends Mensa {
    ...
    public void addMenu(String mensaName, String mensaId, Weekday day, MenuCategory mealType, @NonNull IMenu menu) {
        addMenuForDayAndCategory(day, mealType, Collections.<IMenu>singletonList(new FavoriteMenu(mensaName, menu, mensaId)));
    }
}
